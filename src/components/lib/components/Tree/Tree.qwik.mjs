import { jsxs, jsx, Fragment } from "@qwik.dev/core/jsx-runtime";
import { component$, useSignal, $ } from "@qwik.dev/core";
import { HiChevronUpMini } from "../../node_modules/.pnpm/@qwikest_icons@0.0.13_@builder.io_qwik@1.11.0_vite@6.2.6_@types_node@20.14.11_jiti@2.4.2_tsx@4.19.2_yaml@2.7.0__/node_modules/@qwikest/icons/lib/hi.qwik.qwik.mjs";
    ...
    children: [
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", {
            class: "text-sm",
            children: props.renderNode ? /* @__PURE__ */ jsx(Fragment, {
              children: props.renderNode(props.node)
            }) : `<${props.node.label || props.node.name} ${iterateProps(props.node.props || {})}>`
          })
        ]
      }),
      !isExpanded.value && hasChildren && /* @__PURE__ */ jsx(Fragment, {
        children: props.node.children?.map((child) => /* @__PURE__ */ jsx(TreeNodeComponent, {
          node: child,
          gap: props.gap,
...
const Tree = component$((props) => {
  ...
  return /* @__PURE__ */ jsx("div", {
    ...
    ref,
    children: store.value.map((rootNode) => /* @__PURE__ */ jsx(TreeNodeComponent, {
      gap: props.gap || 20,
      node: rootNode,
      level: 0,
      expandLevel: 2,
