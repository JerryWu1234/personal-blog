...
import { QGreetings } from "./components/Tree.qwik.mjs";
import reactTreeCss from "../../node_modules/.pnpm/react-complex-tree@2.4.6_react@18.2.0/node_modules/react-complex-tree/lib/style-modern.css.qwik.mjs";
...
const Components = component$(() => {
  ...
  return /* @__PURE__ */ jsxs("div", {
    children: [
      /* @__PURE__ */ jsx(QGreetings, {}),
      /* @__PURE__ */ jsx(ComponentsStore, {})
    ]
  });
});
const ComponentsStore = component$(() => {
  ...
  const handleComponentSelected = $((key) => {
    ...
    children: [
      /* @__PURE__ */ jsxs("select", {
        ...
        children: [
          ...
          componentStore.map((key) => /* @__PURE__ */ jsx("option", {
            value: key,
            class: "p-2",
            children: key
          }, key))
      ...
      selectedComponent.value && /* @__PURE__ */ jsx(ComponentStoreUpdate, {
        value: components[selectedComponent.value].state
      })
    ]
  });
});
const ComponentStoreUpdate = component$(({ value }) => {
      ...
      if (value[key].type === "store") {
        return /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            Object.keys(value[key].value).map((storeKey) => /* @__PURE__ */ jsxs("div", {
              class: "flex flex-col",
              children: [
                /* @__PURE__ */ jsxs("h3", {
